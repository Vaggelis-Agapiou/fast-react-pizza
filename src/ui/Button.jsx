...
function Button({children, disabled, to, type, onClick}) {
    ...
    const styles = {
        ...
        secondary: "bg-transparent text-sm border-2 border-stone-300 uppercase font-semibold tracking-wide rounded-full text-stone-400 inline-block hover:bg-stone-300 hover:text-stone-800 transition-colors duration-300 focus:bg-stone-300 focus:outline-none focus:ring focus:ring-stone-200 focus-ring-offset-2 focus:text-stone-800 disabled:cursor-not-allowed py-2.5 px-4 md:px-6 md:py-3.5",
    }
